...
แผนที่ชุดนี้เปรียบเทียบอัตราการติดเชื้อ (Positivity Rate) ในกลุ่มประชากรทั่วไป (Others) โดยอ้างอิงกับค่าเฉลี่ยระดับประเทศที่แตกต่างกัน (เพศหญิง 0.90% / เพศชาย 1.55%):  
